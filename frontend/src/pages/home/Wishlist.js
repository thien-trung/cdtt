                                    ...
                                    {localStorage.getItem('token') ?
                                        this.state.loading ? <tr><td colSpan="6"><div className="spinner-container"><Spinner animation="border" /></div></td></tr> :
                                            this.state.wishlist.length > 0 && this.state.wishlist.map(item => (
                                                <tr key={item.id}>
                                                    <td>
                                                        <img height="100" width="100" src={item.product.photo && require(`../../assets/img/${item.product.photo}`) ? require(`../../assets/img/${item.product.photo}`) : require('../../assets/img/hotdeal.png')} alt={item.product.name} />
                                                    </td>
                                                    <td>
